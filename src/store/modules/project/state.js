...
export default {
    deliveryMethods: [
        { key: 'Design_Bid_Build', value: 'Design_Bid_Build' },
        { key: 'CM_MP', value: 'CM_MP' },
        { key: 'CM_at_Risk', value: 'CM_at_Risk' },
        { key: 'Design_Build', value: 'Design_Build' },
        {
            key: 'Public_Private_Partnership',
            value: 'Public_Private_Partnership',
        },
    ],
    estimateTypes: [
        { key: 'Analogous', value: 'Analogous' },
        { key: 'Parametric', value: 'Parametric' },
        { key: 'ThreePoint', value: 'ThreePoint' },
        { key: 'BottomsUp', value: 'BottomsUp' },
    ],
    procurementMethods: [
        { key: 'LumpSum', value: 'LumpSum' },
        { key: 'CompetitiveBid', value: 'CompetitiveBid' },
        { key: 'CostPlus', value: 'CostPlus' },
        { key: 'TimeAndMaterials', value: 'TimeAndMaterials' },
    ],
    projectScopes: [
        { key: 'Concourse', value: 'Concourse' },
        { key: 'Runway', value: 'Runway' },
        { key: 'JetBreeze', value: 'JetBreeze' },
        { key: 'Concessions', value: 'Concessions' },
    ],
    booleanOptions: [
        { key: true, value: 'True' },
    ...
    measurements: [
        { key: 'SQUARE_FOOT', value: 'Square Foot' },
        { key: 'UNIT_PER', value: 'Per Unit' },
        { key: 'LINEAR_FOOT', value: 'Linear Foot' },
    ],
};
