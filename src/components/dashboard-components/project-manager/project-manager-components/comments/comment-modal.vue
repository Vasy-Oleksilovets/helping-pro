...
<div>
    ...
    <transition name="fade">
        <EstimatesCell v-if="getSelectedEstimateLine && openLeftModal" :estimateLine="getSelectedEstimateLine" :level="1" class="comment-estimate-line" />
    </transition>
    <div class="d-flex" :class="openRightModal && !openLeftModal ? 'position-absolute w-100' : ''">
        <!-- Left Comment Modal -->
